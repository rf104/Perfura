  ...
  const sampleProducts: Product[] = [
    {
      ...
      brand: 'Euro Vally',
      price: 799,
      description: 'Its a perfume of fruity flavor and sweet smell and long lasting.Speacially it smells like strawberry and musk',
      image_url: '/images/34.jpg',
      category: 'Floral',
      volume: '30ml',
      notes: ['Strawberry', 'Musk', 'Vanilla'],
      rating: 4.8,
    ...
    },
    {
      ...
      image_url: '/images/coolwater.jpeg',
      category: 'Citrus',
      volume: '30ml',
    ...
    },
    {
      ...
      brand: 'PERENNIX',
      price: 899,
      description: 'blueberry musk perfume long lasting fragrance for men and women which smells like fresh blueberries mixed with soft musk and a hint of vanilla',
      image_url: '/images/post4.png',
      category: 'Oriental',
      volume: '30ml',
      notes: ['Blueberry', 'Vanila', 'Musk'],
      rating: 4.9,
      created_at: new Date().toISOString()
    },
    {
      ...
      brand: 'Euro Vally',
      price: 799,
      description: 'Vampire Blood is a captivating fragrance that combines the sweetness of ripe berries with the warmth of vanilla and the depth of musk.',
      image_url: '/images/post5.png',
      category: 'Oriental',
      volume: '30ml',
      notes: ['Strawberry', 'fruity', 'fresh'],
      rating: 4.9,
      created_at: new Date().toISOString()
    },
    {
